...
import {View, Text,TextInput,ListView ,StyleSheet,TouchableOpacity} from "react-native";
...
class DefaultTabBar extends React.Component {
    ...
    componentDidMount() {
        ...
        renderTabOption(tab, i) {
            const color = this.props.activeTab == i? "#FFFFFF" : "#000000"; // 判断i是否是当前选中的tab，设置不同的颜色
            return (
